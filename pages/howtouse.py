...
dash.register_page(__name__,path='/howtouse',title="Simulation Learning App",description="Simulation Learning App",image='logoweb1.png')
        ...
        dbc.Col(
            dbc.Breadcrumb(
                items=[
                    ...
                    {"label": "How to use this Application", "active": True},
                ],
            )
        )
    ),
...
initial_paragraph_content = dbc.Container([
    dbc.Row([
        dbc.Col([
            html.H3(html.B("How to use this Application? "))
        ])
    ]),
    dbc.Row([
        dbc.Col([
